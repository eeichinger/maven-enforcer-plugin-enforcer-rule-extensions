    ...
    implements PlexusContainer
{
    ...
    public void addComponent(Class clazz, Object object) {
        addComponent(clazz.getName(), object);
    }

    public void addComponent(String theComponentKey, Object object) {
        registeredComponents.put(theComponentKey, object);
    }
