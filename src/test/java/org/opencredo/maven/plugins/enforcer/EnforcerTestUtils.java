...
import org.opencredo.maven.plugins.enforcer.utils.MockEnforcerExpressionEvaluator;
...
public final class EnforcerTestUtils
{
    ...
    public static MavenSession getMavenSession()
    {
        ...
        return new MavenSession(container, null, null, null, null, null, null, new Properties(),
                                 new Date() );
    }
